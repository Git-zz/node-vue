        ...
        <el-form label-width="120px" @submit.native.prevent="save">
            <el-tabs type="border-card" value="basic">
                ...
                <el-tab-pane label="英雄攻略" name="content">
                    ...
                    <el-row type="flex" style="flex-wrap: wrap">
                        <el-col :md="12" v-for="(item ,i) in model.content" :key="i">
                            <el-form-item label="名称">
                            ...
                            <el-form-item label="英雄攻略">
                                <vue-editor v-model="item.body" useCustomImageHandler @imageAdded="handleImageAdded"></vue-editor>
                            </el-form-item>
                            <el-form-item>
                                <el-button size="small" type="danger" @click="model.content.splice(i,1)">删除</el-button>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-tab-pane>
